...
class Genpdf_models extends CI_Model {
    ...
    public function Account_all_1($id,$type,$date_start,$date_end)
	{
      ...
      if($type == "cash"){
        $this->db->where('account_menu','รายรับจากการขายสด');
      }else if($type == "debtor"){
        $this->db->where('account_menu','รายรับจากการขายเชื่อ');
      }else if($type == "online"){
        $this->db->where('account_menu','รายรับจากการขายออนไลน์');
      }else if($type == "purchase_cash"){
        $this->db->where('account_menu','รายจ่ายจากการสั่งซื้อสินค้า');
      }else if($type == "purchase_debtor"){
        $this->db->where('account_menu','รายจ่ายจากการชำระหนี้');
      }
  ...
  public function sell_detail_history($id,$date_start,$date_end)
{
...
public function sell_detail_history_online($id,$date_start,$date_end)
{
  ...
  public function conclude_sell($id,$date_start,$date_end)
{
    ...
    $this->db->where('sell_detail_type','1');
