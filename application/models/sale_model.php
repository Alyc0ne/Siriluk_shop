...
class sale_model extends CI_Model{
  ...
  public function getuserNew($data){
      $result=$this->db->where('stock_detail_id',$data)->get('stock_detail')->row_array();

      return $result;
  }

  public function get_stock_detail($data){
  ...
  public function get_member($data){
      $result=$this->db->where('member_id',$data)->get('member')->row_array();
  ...
  public function get_partner($id){
    $rs=$this->db->where('partners_id',$id)->get('partners')->row_array();
    return $rs;
  }

  public function get_Creditor($id){
    $rs=$this->db->where('creditor_id',$id)->get('creditor')->row_array();
    return $rs;
  }
